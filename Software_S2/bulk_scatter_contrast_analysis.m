...
theta_rad = theta;
contrast.mean = [contrast_fwrd.mean; flipud(contrast_bck.mean)];
contrast.std = [contrast_fwrd.std; flipud(contrast_bck.std)];
contrast.count = [contrast_fwrd.count; flipud(contrast_bck.count)];
contrast.sem = (contrast.std)./sqrt(contrast.count);
...
WSFC.count = [WSFC_fwrd.count; flipud(WSFC_bck.count)];
WSFC.sem = (WSFC.std)./sqrt(WSFC.count);

BSFC.mean = [BSFC_fwrd.mean; flipud(BSFC_bck.mean)];
BSFC.std  = [BSFC_fwrd.std;  flipud(BSFC_bck.std)];
BSFC.count = [BSFC_fwrd.count; flipud(BSFC_bck.count)];
BSFC.sem = (BSFC.std)./sqrt(BSFC.count);
